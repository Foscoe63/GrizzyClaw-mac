...
public struct GitHubSkillImportSheet: View {
    ...
    public init(isPresented: Binding<Bool>, onImportedSkillIDs: @escaping ([String]) -> Void) {
        _isPresented = isPresented
        self.onImportedSkillIDs = onImportedSkillIDs
    }
