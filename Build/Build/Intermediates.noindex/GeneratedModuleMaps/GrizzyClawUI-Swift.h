...
#ifndef GRIZZYCLAWUI_SWIFT_H
#define GRIZZYCLAWUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GrizzyClawUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <code>applicationWillFinishLaunching</code>, not in <code>App.init()</code> (too early on some macOS/Xcode combos → no window, immediate exit).
SWIFT_CLASS("_TtC12GrizzyClawUI21GrizzyClawAppDelegate")
@interface GrizzyClawAppDelegate : NSObject <NSApplicationDelegate>
...
/// Must be <code>false</code> here: returning <code>true</code> with SwiftUI <code>WindowGroup</code>/<code>Window</code> has been observed to end the
